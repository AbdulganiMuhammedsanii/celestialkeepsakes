      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-3xl font-bold text-white">Join the Stars</h1>
            <p className="text-slate-300">Create your celestial account</p>
          </div>

          <Card className="bg-white/10 backdrop-blur-md border-white/20">
            <CardHeader>
              <CardTitle className="text-2xl text-white">Sign Up</CardTitle>
              <CardDescription className="text-slate-300">Create a new account to save your star maps</CardDescription>
            </CardHeader>
            <CardContent>
