      ...
      <div className="rounded-2xl border card-glass p-8">
        <div className="flex items-start justify-between gap-6 flex-col md:flex-row">
          <div className="flex-1">
            ...
            <p className="text-muted-foreground mb-4">Pay $6.99 to receive your high‑resolution PDF instantly, or order a physical print.</p>
          ...
          <div className="w-full md:w-64 rounded-xl border p-4 bg-background/40">
            ...
            <div className="flex items-center justify-between text-sm mb-1"><span>Custom Star Map PDF</span><span>$6.99</span></div>
            {config && (
              <>
